...
window.openAddExpenseForCategory = function(catName) {
    ...
    openExpenseModal('', catName, defaultAcc);
};
                ...
                card.innerHTML = `
                    ...
                    <div class="exp-cat-body" style="display: ${autoExpand ? 'block' : 'none'};">
                        ...
                        <div class="exp-cat-top-bar" onclick="event.stopPropagation()">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" onclick="openAddExpenseForCategory('${cat}')" style="font-size:11px; padding:5px 12px; display:inline-flex; align-items:center; gap:4px; font-weight:700; ${cat === 'Household Petty Cash' ? 'background:#0d9488; border-color:#0d9488;' : 'box-shadow:0 2px 5px rgba(13,148,136,0.25);'}">
        ...
        if (displayRows.length === 0) {
            ...
            sortedRows.forEach(row => {
                ...
                if (row.isExpense) {
                    ...
                    if (txRef && txRef.spentBy) {
                        memberPill = `<span class="badge-spent-by">👤 ${txRef.spentBy}</span>`;
                    }
                }
    ...
    div.innerHTML = `
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-left: 4px solid #0d9488; border-radius: 6px; padding: 10px 14px; margin-bottom: 20px;">
            ...
            <div style="font-size: 10.5px; color: #475569; line-height: 1.45;">
                We appreciate your prompt settlement and look forward to continuing our valued partnership with <strong>Arya Associates</strong>.
            </div>
        </div>
...
------------------------------------------------
✨ *Thank you for your continued trust and support!* We appreciate your prompt settlement and look forward to continuing our valued partnership with *Arya Associates*.
...
function handleExpenseSubmit(e) {
    ...
    let txObj = { description, category, amount, date, mode, clientId, spentBy };
